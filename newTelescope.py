    ...
    def write_schedule(self, observatory_name, obs_date, targets):
        ...
        with open(file_to_write,"w") as csvoutput:
            ...
            for t in targets:
                ...
                skipV = False
                specialExposure = 0
                if t.name=='2018bcb' or t.name=='2018dyb' or t.name=='2018fyk' or t.name=='2018hyz' or t.name=='2018ido' or t.name=='2018lna' or t.name=='2018jbv':
                    print(t.name + " oops1")
                    skipV = True
                onlyR = False
                if t.name=='2005ip' or t.name=='2009ip' or t.name=='2010da' or t.name=='2013L':
                    print(t.name + " oops2")
                    onlyR = True
                    specialExposure=900
                ...
                # Flip order: BVugir
                    ...
                    if (not onlyR): 
                        ...
                        if skipV or t.name=='2019com':
                            specialExposure=600
                        output_rows.append(self.swope_filter_row(Constants.B_band, specialExposure))
                        if (not skipV):
                            output_rows.append(self.swope_filter_row(Constants.V_band, t.exposures[Constants.V_band]))
                        ...
                        if skipV or t.name=='2019com':
                            specialExposure=600
                        output_rows.append(self.swope_filter_row(Constants.g_band, specialExposure))
